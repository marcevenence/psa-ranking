...
public class ProvinceResourceIT {
    ...
    private static final String DEFAULT_ISO_ID = "AAAAAAAAAA";
    private static final String UPDATED_ISO_ID = "BBBBBBBBBB";

    private static final Long DEFAULT_GOB_ID = 1L;
    private static final Long UPDATED_GOB_ID = 2L;
    ...
    public static Province createEntity(EntityManager em) {
        Province province = new Province()
            ...
            .isoId(DEFAULT_ISO_ID)
            .gobId(DEFAULT_GOB_ID);
        return province;
    }
    /**
    ...
    public static Province createUpdatedEntity(EntityManager em) {
        Province province = new Province()
            ...
            .isoId(UPDATED_ISO_ID)
            .gobId(UPDATED_GOB_ID);
        return province;
    }
    ...
    public void createProvince() throws Exception {
        ...
        assertThat(testProvince.getIsoId()).isEqualTo(DEFAULT_ISO_ID);
        assertThat(testProvince.getGobId()).isEqualTo(DEFAULT_GOB_ID);
    }
    ...
    public void getAllProvinces() throws Exception {
        ...
        restProvinceMockMvc.perform(get("/api/provinces?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].isoId").value(hasItem(DEFAULT_ISO_ID)))
            .andExpect(jsonPath("$.[*].gobId").value(hasItem(DEFAULT_GOB_ID.intValue())));
    }
    ...
    public void getProvince() throws Exception {
        ...
        restProvinceMockMvc.perform(get("/api/provinces/{id}", province.getId()))
            ...
            .andExpect(jsonPath("$.isoId").value(DEFAULT_ISO_ID))
            .andExpect(jsonPath("$.gobId").value(DEFAULT_GOB_ID.intValue()));
    }
    ...
    public void updateProvince() throws Exception {
        ...
        assertThat(testProvince.getIsoId()).isEqualTo(UPDATED_ISO_ID);
        assertThat(testProvince.getGobId()).isEqualTo(UPDATED_GOB_ID);
    }
