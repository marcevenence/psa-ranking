...
public class TournamentResourceIT {
    ...
    private static final Instant DEFAULT_END_INSCRIPTION_DATE = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_END_INSCRIPTION_DATE = Instant.now().truncatedTo(ChronoUnit.MILLIS);
    ...
    public void createTournament() throws Exception {
        ...
        assertThat(testTournament.getPlayDate()).isEqualTo(DEFAULT_PLAY_DATE);
        assertThat(testTournament.getEndInscriptionDate()).isEqualTo(DEFAULT_END_INSCRIPTION_DATE);
    ...
    public void updateTournament() throws Exception {
        ...
        assertThat(testTournament.getPlayDate()).isEqualTo(UPDATED_PLAY_DATE);
        assertThat(testTournament.getEndInscriptionDate()).isEqualTo(UPDATED_END_INSCRIPTION_DATE);
