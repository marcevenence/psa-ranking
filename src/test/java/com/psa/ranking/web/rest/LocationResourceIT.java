...
public class LocationResourceIT {
    ...
    public void createLocation() throws Exception {
        ...
        assertThat(testLocation.getFullName()).isEqualTo(DEFAULT_FULL_NAME);
        assertThat(testLocation.getGobId()).isEqualTo(DEFAULT_GOB_ID);
    ...
    public void updateLocation() throws Exception {
        ...
        assertThat(testLocation.getFullName()).isEqualTo(UPDATED_FULL_NAME);
        assertThat(testLocation.getGobId()).isEqualTo(UPDATED_GOB_ID);
