...
describe('Service Tests', () => {
  describe('Tournament Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Tournament(0, 'AAAAAAA', currentDate, currentDate, Status.CREATED, false, currentDate, currentDate);
    });
    ...
    describe('Service methods', () => {
      it('should find an element', () => {
        const returnedFromService = Object.assign(
          {
            playDate: currentDate.format(DATE_TIME_FORMAT),
            endInscriptionDate: currentDate.format(DATE_TIME_FORMAT),
