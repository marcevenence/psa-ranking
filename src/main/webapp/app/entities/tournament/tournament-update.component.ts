...
export class TournamentUpdateComponent implements OnInit {
  ...
  updateForm(tournament: ITournament) {
    this.editForm.patchValue({
      ...
      playDate: tournament.playDate != null ? tournament.playDate.format(DATE_TIME_FORMAT) : null,
      endInscriptionDate: tournament.endInscriptionDate != null ? tournament.endInscriptionDate.format(DATE_TIME_FORMAT) : null,
  ...
  private createFromForm(): ITournament {
    return {
      ...
      playDate: this.editForm.get(['playDate']).value != null ? moment(this.editForm.get(['playDate']).value, DATE_TIME_FORMAT) : undefined,
      endInscriptionDate:
        this.editForm.get(['endInscriptionDate']).value != null
          ? moment(this.editForm.get(['endInscriptionDate']).value, DATE_TIME_FORMAT)
          : undefined,
