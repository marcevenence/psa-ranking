...
export class EventUpdateComponent implements OnInit {
  ...
  updateForm(event: IEvent) {
    this.editForm.patchValue({
      id: event.id,
      name: event.name,
      playDate: event.playDate != null ? event.playDate.format(DATE_TIME_FORMAT) : null,
      endInscriptionDate: event.endInscriptionDate != null ? event.endInscriptionDate.format(DATE_TIME_FORMAT) : null,
      status: event.status,
      active: event.active,
